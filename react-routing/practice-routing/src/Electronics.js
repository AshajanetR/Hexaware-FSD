...
const Electronics = () => {
  ...
  return (
    <>
         {
        electronicItems.map((e)=><Link to={`/showprod/${e.itemCode}/${e.name}/${e.price}/${e.quantity}/${e.city}`}><ECard itemCode={e.itemCode} name={e.name} price={e.price} quantity={e.quantity} city={e.city}/></Link>)
        }
